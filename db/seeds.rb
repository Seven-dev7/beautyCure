...
def create_services
    ...
    Service.create!( title: "Extensions de cils", description: "Extensions de cils naturels" , price: 15000, duration: 60)
    Service.create!( title: "Extensions de cils", description: "Extensions de cils compléte" , price: 20000, duration: 60)
    Service.create!( title: "Extensions de cils", description: "Extensions de cils Sophistiquée" , price: 30000, duration: 60)
    Service.create!( title: "Extensions de cils", description: "Extensions de cils Russe" , price: 50000, duration: 60)
